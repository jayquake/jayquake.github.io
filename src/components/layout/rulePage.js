      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        >
          ...
          >
            ...
            The requested accessibility rule could not be loaded. Please check the URL or try again.
          </Alert>
      ...
      >
        ...
        <Grid container spacing={3} alignItems="center">
          <Grid item xs={12}>
            ...
            <Typography variant="h6" sx={{ mb: 2, color: '#475569', fontWeight: 400 }}>
        ...
        <AccordionDetails>
          ...
          >
            <Tooltip title={copied ? "Copied!" : "Copy resolution code"}>
              <IconButton
                onClick={() => navigator.clipboard.writeText(ruleData.issueResolution)}
                sx={{
                  position: 'absolute',
                  top: 8,
                  right: 8,
