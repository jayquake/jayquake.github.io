...
const DialogModalMismatchSuccess = () => {
  ...
  const helpText = `Add aria-modal="true" alongside role="dialog" to indicate to screen readers that the dialog is modal and that content outside of it should be treated as inactive. Screen readers will recognize this and adjust their behavior to keep the user’s focus inside the dialog.`;
  const bestPractices = [
...
<div>body content</div>` },
  { filename: "dialog open", content: `<style>
  dialog {
    width: 250px;
    height: 200px;
  }
...
<dialog open>
  ...
  { filename: "modal with attributes", content: `<body style="margin: 0; height: 100%">
  ...
  <div tabindex="-1" class="ant-modal-wrap" style="height: 100vh; width: 100vw; overflow: auto; position: fixed; z-index: 1000; background-color: rgba(165, 165, 165, 0.2)">
    <div id="test-subject" role="dialog" aria-labelledby=":rf:" aria-modal="true" class="ant-modal" style="position: relative; transform: translate(-50%, -50%); top: 50%; left: 50%; width: 502px; z-index: 900">
...
export default DialogModalMismatchSuccess;
