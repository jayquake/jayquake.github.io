...
<button aria-labelledby="my-label"></button>` },
  { filename: "button no text with aria label", content: `<button aria-label="Clickable Download Link"></button>` },
  { filename: "button svg icon labelled", content: `<style>
  .sr-only {
    position: absolute;
    width: 1px;
    height: 1px;
...
<button id="test-subject">
  <svg style="width:100px;height:100px;" >
    <circle cx="50" cy="50" r="40" stroke="black" stroke-width="3" fill="red" />
  </svg>
  <span class="sr-only">Search</span>
</button>` },
  { filename: "button with discernible image", content: `<button><img alt="This is an image inside button" /></button>` },
  { filename: "button with text", content: `<button>Clickable Download Link</button>` },
  { filename: "cart button with aria label", content: `<div
  id="cart"
...
<style></style>` },
  { filename: "invisible button with text", content: `<button style="display: none;">Clickable Download Link</button>` },
  { filename: "plus minus buttons with aria labels", content: `<div
...
export default ButtonDiscernibleSuccess;
