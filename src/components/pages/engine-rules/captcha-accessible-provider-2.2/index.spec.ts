import { CaptchaAccessibleProvider_v2_2 as CaptchaAccessibleProvider } from ".";
...
describe("CaptchaAccessibleProvider Rule Validation", () => {
  ...
  it("should have failed nodes when there's a cloudflare turnstile captcha element", async () => {
    const { response, document, classifier } = validateMethodArguments;
