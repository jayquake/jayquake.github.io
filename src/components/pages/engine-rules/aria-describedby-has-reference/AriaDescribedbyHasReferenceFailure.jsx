...
const AriaDescribedbyHasReferenceFailure = () => {
  ...
  const htmlExamples = [
  { filename: "input with aria describedby but no matching element id", content: `<input aria-label="Field label" aria-describedby="description" />
<div id="description-bad-id">Some description</div>` },
  { filename: "input with aria describedby but no matching element", content: `<input aria-label="Field label" aria-describedby="description" />` },
  { filename: "input with valid aria describedby and invalid aria labelledby", content: `<input aria-label="Field label" aria-labelledby="label" aria-describedby="description" />
