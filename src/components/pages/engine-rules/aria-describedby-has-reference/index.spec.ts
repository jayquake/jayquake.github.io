import { AriaDescribedByHasReference } from ".";
import type { ValidationMethodArguments } from "../../../test/unit/helpers/validation-method-arguments";
import validationMethodArguments from "../../../test/unit/helpers/validation-method-arguments";

describe("AriaDescribedByHasReference Rule Validation", () => {
  ...
  it("should have no failed nodes when element with aria-describedby attribute has an element with fitting id", async () => {
    ...
    await AriaDescribedByHasReference.validate(validateMethodArguments);
