...
<style>
  ...
  { filename: "input checkbox", content: `<div class="checkbox-wrapper-1">
...
<style>
  ...
  <label id="test-subject" class="toggleButton" role="checkbox" aria-checked="true" tabindex="0">
    <input type="checkbox" />
    <div>
...
export default CheckboxAriaCheckedSuccess;
