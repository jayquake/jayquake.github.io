...
const ImageDiscernibleCorrectlySuccess = () => {
  ...
  const htmlExamples = [
  { filename: "easyfinancial.com image with svg src", content: `<img data-src="../assets/GoeasyConnect.e75d4a9a.svg" src="../assets/GoeasyConnect.e75d4a9a.svg" alt="GoeasyConnect.e75d4a9a.svg" width="82px" height="100%" class="lazy entered loaded" data-ll-status="loaded" />` },
  { filename: "image with base64 src", content: `<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==" alt="Test image" />` },
  { filename: "image with linear gradient", content: `<img src="linear-gradient(to right, red, blue)" alt="Gradient" />` },
  ...
  { filename: "image with svg data uri", content: `<img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg'%3E%3C/svg%3E" alt="SVG image" />` },
  { filename: "image with svg src", content: `<img src="image.svg" alt="SVG file" />` }
  ];
