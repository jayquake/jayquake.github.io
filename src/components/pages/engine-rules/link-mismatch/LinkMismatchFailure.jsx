...
const LinkMismatchFailure = () => {
  ...
  const htmlExamples = [
  { filename: "check out button without role link", content: `<button
...
<style>
  ...
  { filename: "checkout button without role link", content: `<button
  type="submit"
...
export default LinkMismatchFailure;
