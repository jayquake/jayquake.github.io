...
const CarouselSlidePickerDiscernibleFailure = () => {
  ...
  { filename: "carousel slide picker not labelled", content: `<div id="test-subject" class="carousel" role="region" aria-roledescription="carousel" aria-label="News feed">
    ...
    <div class="container">
        <button class="pagination-control"></button>
        <button class="pagination-control"></button>
        <button class="pagination-control"></button>
    </div>
</div>` },
  { filename: "vuetifyjs carousel slide pickers not labelled", content: `<link rel="stylesheet" href="../assets/vuetify/style-DpYeMxzX.css">
        ...
        <div id="test-subject" role="region" aria-roledescription="carousel" aria-label="example of slides"
            ...
            <div class="v-carousel__controls" style="left: auto; right: auto;">
                <div class="v-item-group theme--dark"><button type="button" value="0"
                        class="v-carousel__controls__item v-btn v-btn--icon v-btn--round theme--dark v-size--small""><span class="v-btn__content"><span aria-hidden="true"
                                class="v-icon notranslate theme--dark"
                        ...
                        class="v-carousel__controls__item v-btn v-item--active v-btn--active v-btn--icon v-btn--round theme--dark v-size--small""><span class="v-btn__content"><span aria-hidden="true"
                                class="v-icon notranslate theme--dark"
                                style="font-size: 18px; height: 18px; width: 18px;"><svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true"
                                    class="v-icon__svg" style="font-size: 18px; height: 18px; width: 18px;">
...
export default CarouselSlidePickerDiscernibleFailure;
