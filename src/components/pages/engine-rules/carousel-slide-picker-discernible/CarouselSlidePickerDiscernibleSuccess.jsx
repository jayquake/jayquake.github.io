...
const CarouselSlidePickerDiscernibleSuccess = () => {
  ...
  { filename: "carousel slide picker not labelled", content: `<div id="test-subject" class="carousel" role="region" aria-roledescription="carousel" aria-label="News feed">
    ...
    <div class="container">
        <button class="pagination-control" aria-label="Go to Slide 1">1</button>
        <button class="pagination-control" aria-label="Go to Slide 2">2</button>
        <button class="pagination-control" aria-label="Go to Slide 3">3</button>
    </div>
</div>` },
  { filename: "vuetifyjs carousel slide pickers correctly labelled", content: `<link rel="stylesheet" href="../assets/vuetify/style-DpYeMxzX.css">
        ...
        <div class="text-end pa-2"><span class="v-app-tooltip-btn d-inline-block"><button type="button"
                ...
                class="v-app-tooltip-btn d-inline-block"><button type="button"
                    ...
                    aria-label="view-in-github"><span class="v-btn__content"><span aria-hidden="true"
                            ...
                            </svg></span></span></button><span class="v-tooltip v-tooltip--bottom"><!----></span></span><span
                class="v-app-tooltip-btn d-inline-block"><button type="button"
...
export default CarouselSlidePickerDiscernibleSuccess;
