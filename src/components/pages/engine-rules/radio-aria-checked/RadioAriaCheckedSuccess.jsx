...
<style>
  ...
  { filename: "input radio button", content: `<div class="radio-wrapper-1">
...
<style>
  ...
  { filename: "label as a custom radio button", content: `<div class="radio-wrapper-44">
  <label id="test-subject" class="toggleButton" role="radio" aria-checked="true" tabindex="0">
    <input type="radio" />
    <div>
...
export default RadioAriaCheckedSuccess;
