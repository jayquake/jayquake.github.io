...
const AriaInvalidMisuseFailure = () => {
  ...
  const htmlExamples = [
  { filename: "input with aria invalid grammar", content: `<input aria-label="Field label" aria-invalid="grammar" aria-describedby="description" />
<div id="description">Some description</div>` },
  { filename: "input with aria invalid spelling", content: `<input aria-label="Field label" aria-invalid="spelling" aria-describedby="description" />
<div id="description">Some description</div>` },
  { filename: "input with aria invalid true", content: `<input aria-label="Field label" aria-invalid="true" aria-describedby="description" />
<div id="description">Some description</div>` },
  { filename: "input with empty aria invalid", content: `<input aria-label="Field label" aria-invalid aria-describedby="description" />
<div id="description">Some description</div>` }
  ];
