...
```json
{
  ...
  "ref": "e16",
  "text": "qa-automation+f9a76663@accessibe.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('qa-automation+f9a76663@accessibe.com');
```
...
```json
{
  ...
  "ref": "e21",
  "text": "1771156805899.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('1771156805899.com');
```
