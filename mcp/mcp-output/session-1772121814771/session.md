...
```json
{
  "url": "https://test:acsb123@sdk-selenium--accessflow--test.acsb-test.com/staging-setup"
}
```
- Code
```js
await page.goto('https://test:acsb123@sdk-selenium--accessflow--test.acsb-test.com/staging-setup');
```
...
```json
{
  "url": "https://sdk-selenium--accessflow--test.acsb-test.com/staging-setup"
}
```
- Code
```js
await page.goto('https://sdk-selenium--accessflow--test.acsb-test.com/staging-setup');
```
...
```json
{
  ...
  "ref": "e21",
  "text": "qa-automation+5ed9b0cc@accessibe.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('qa-automation+5ed9b0cc@accessibe.com');
```
...
```json
{
  ...
  "ref": "e26",
  "text": "1772121643176.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('1772121643176.com');
```
...
```json
{
  "url": "https://sdk-selenium--accessflow--test.acsb-test.com/journeys"
}
```
- Code
```js
await page.goto('https://sdk-selenium--accessflow--test.acsb-test.com/journeys');
```
