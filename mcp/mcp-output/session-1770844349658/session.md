...
{
  "found": false,
  "locator": "getByRole('region', { name: /Site access settings/i })"
}
```
- Code
```js
...
- Result
```
Took the viewport screenshot and saved it as /Users/jasonquaicoo/Desktop/accessE2E/mcp/mcp-output/page-2026-02-11T21-12-37-000Z.png
```
- Code
```js
// Screenshot viewport and save it as /Users/jasonquaicoo/Desktop/accessE2E/mcp/mcp-output/page-2026-02-11T21-12-37-000Z.png
