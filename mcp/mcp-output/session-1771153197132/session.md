...
```json
{
  ...
  "ref": "e16",
  "text": "qa-automation+f4e54017@accessibe.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('qa-automation+f4e54017@accessibe.com');
```
...
```json
{
  ...
  "ref": "e21",
  "text": "1771149755601.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('1771149755601.com');
```
...
- Result
```
Took the viewport screenshot and saved it as /Users/jasonquaicoo/Desktop/accessE2E/mcp/mcp-output/page-2026-02-15T11-00-21-652Z.png
```
- Code
```js
// Screenshot viewport and save it as /Users/jasonquaicoo/Desktop/accessE2E/mcp/mcp-output/page-2026-02-15T11-00-21-652Z.png
