...
```json
{
  ...
  "ref": "e16",
  "text": "qa-automation+4972909d@accessibe.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('qa-automation+4972909d@accessibe.com');
```
...
```json
{
  ...
  "ref": "e21",
  "text": "1771970429038.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('1771970429038.com');
```
...
- Result
```
Took the viewport screenshot and saved it as /Users/jasonquaicoo/Desktop/accessE2E/mcp/mcp-output/page-2026-02-24T22-10-50-117Z.png
```
- Code
```js
// Screenshot viewport and save it as /Users/jasonquaicoo/Desktop/accessE2E/mcp/mcp-output/page-2026-02-24T22-10-50-117Z.png
...
{
  "name": "navigate",
  "url": "https://journey-seco--accessflow--test.acsb-test.com/dashboard"
}
```
- Code
```js
await page.goto('https://journey-seco--accessflow--test.acsb-test.com/dashboard');
```
