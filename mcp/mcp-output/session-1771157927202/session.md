...
```json
{
  ...
  "ref": "e16",
  "text": "qa-automation+65bda985@accessibe.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('qa-automation+65bda985@accessibe.com');
```
...
```json
{
  ...
  "ref": "e21",
  "text": "1771157749668.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('1771157749668.com');
```
