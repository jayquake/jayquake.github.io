...
```json
{
  ...
  "ref": "e21",
  "text": "jason@digivate.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('jason@digivate.com');
```
...
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('digivate.com');
```
...
```json
{
  "url": "https://test:acsb123@journey-seco--accessflow--test.acsb-test.com/journeys"
}
```
- Code
```js
await page.goto('https://test:acsb123@journey-seco--accessflow--test.acsb-test.com/journeys');
```
