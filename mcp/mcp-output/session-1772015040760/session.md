...
```json
{
  ...
  "ref": "e16",
  "text": "qa-automation+bd3c1c47@accessibe.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'User Email' }).fill('qa-automation+bd3c1c47@accessibe.com');
```
...
```json
{
  ...
  "ref": "e21",
  "text": "1772009258209.com"
}
```
- Code
```js
await page.getByRole('textbox', { name: 'Domain' }).fill('1772009258209.com');
```
